...
<html lang="en" dir="ltr">
    ...
    <br><br><br><br><br><br><br><br><br>
            ...
            <table class="table_assistance">
                <tr>
                    <td colspan="6" rowspan="1" style="text-align:center; background:#1b1b1c;color:white">
                        <h2><center>REPORTE DE COMPRAS DEL DÍA {{date('d/m/Y', strtotime($data['fecha'])).' ('.$data['storage']->name.')'}}</center></h2>
                    </td>
                </tr>
                <thead>
                    <tr>
