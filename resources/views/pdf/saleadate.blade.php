            ...
            <table class="table_assistance">
                <tr>
                    <td colspan="7" rowspan="1" style="text-align:center; background:#1b1b1c;color:white">
                        <h2><center>REPORTE DE VENTAS DEL DÍA {{date('d/m/Y', strtotime($data['fecha']))}} ({{$data['storage']->name}}) </center></h2>
                    </td>
                </tr>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="6" style="text-align:right;font-weight:bold;">TOTAL DE VENTAS</td>
