...
<head>
    ...
    <style>
        ...
        .table_assistance tr td,
        .table_assistance tr th {
            padding: 4px;
        ...
        <div>
            <table class="table_assistance" style="">
                ...
                <tr>
                    ...
                    <td colspan="1" rowspan="1" style="text-align:left;">{{$data['sale']->type_doc}}</td>
                </tr>
                <tr>
                    <td colspan="1" rowspan="1" style="text-align:left; width:100px!important;font-weight:bold;background: #dbdedf">
                        NÚMERO DE DOCUMENTO
                    </td>
                    <td colspan="1" rowspan="1" style="text-align:left;">{{$data['sale']->number_doc}}</td>
                </tr>
                <tr>
                    <td colspan="1" rowspan="1" style="text-align:left; width:100px!important;font-weight:bold;background: #dbdedf">
                        OBSERVACIÓN
                    </td>
                    <td colspan="1" rowspan="1" style="text-align:left;">{{$data['sale']->observation}}</td>
                </tr>
                <tr>
                    <td colspan="1" rowspan="1" style="text-align:left; width:100px!important;font-weight:bold;background: #dbdedf">
                        CLIENTE
                    </td>
                    <td colspan="1" rowspan="1" style="text-align:left;">{{$data['sale']->client->name}}</td>
                </tr>
                <tr>
                    <td colspan="1" rowspan="1" style="text-align:left; width:100px!important;font-weight:bold;background: #dbdedf">
                        SUCURSAL
                    </td>
                    <td colspan="1" rowspan="1" style="text-align:left;">{{$data['sale']->storage->name}}</td>
                </tr>
            </table>
            <table class="table_assistance">
                ...
                <tbody>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="5" style="text-align:right;font-weight:bold;">IGV</td>
                        <td colspan="1" style="font-weight:bold;background:#1b1b1c;color:white;text-align:right;font-size:13px"><b>S/. {{sprintf('%.2f',round($data['sale']->igv,2))}}</b></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align:right;font-weight:bold;">SUBTOTAL</td>
                        <td colspan="1" style="font-weight:bold;background:#1b1b1c;color:white;text-align:right;font-size:13px"><b>S/. {{sprintf('%.2f',round($data['sale']->subtotal,2))}}</b></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align:right;font-weight:bold;">TOTAL</td>
                        <td colspan="1" style="font-weight:bold;background:#1b1b1c;color:white;text-align:right;font-size:13px"><b>S/. {{sprintf('%.2f',round($data['sale']->total,2))}}</b></td>
                    </tr>
                </tbody>
            </table>
        </div>
